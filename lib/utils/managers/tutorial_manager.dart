...
class TutorialManager {
  ...
  // Game mode specific tutorial keys
  static const String _guessTheSoundTutorialKey = 'guess_the_sound_tutorial_shown';
  static const String _guessTheMusicTutorialKey = 'guess_the_music_tutorial_shown';
  static const String _trueOrFalseTutorialKey = 'true_or_false_tutorial_shown';
  static const String _vocabularyTutorialKey = 'vocabulary_tutorial_shown';
  static const String _guessTheImageTutorialKey = 'guess_the_image_tutorial_shown';
  ...
  /// Check if a specific game mode tutorial has been shown
  static Future<bool> isGameModeTutorialShown(String gameModeId) async {
    final prefs = await SharedPreferences.getInstance();
    String key;
    
    switch (gameModeId) {
      case 'GuessTheSound':
        key = _guessTheSoundTutorialKey;
        break;
      case 'GuessTheMusic':
        key = _guessTheMusicTutorialKey;
        break;
      case 'TrueOrFalse':
        key = _trueOrFalseTutorialKey;
        break;
      case 'Vocabulary':
        key = _vocabularyTutorialKey;
        break;
      case 'GuessTheImage':
        key = _guessTheImageTutorialKey;
        break;
      default:
        return false;
    }
  ...
  /// Mark a specific game mode tutorial as shown
  static Future<void> markGameModeTutorialShown(String gameModeId) async {
    final prefs = await SharedPreferences.getInstance();
    String key;
  ...
  static Future<void> resetTutorials() async {
    ...
    await prefs.remove(_guessTheSoundTutorialKey);
    await prefs.remove(_guessTheMusicTutorialKey);
    await prefs.remove(_trueOrFalseTutorialKey);
    await prefs.remove(_vocabularyTutorialKey);
    await prefs.remove(_guessTheImageTutorialKey);
  }
